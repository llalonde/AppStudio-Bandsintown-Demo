...
namespace AppStudio
{
    ...
    {
        public const string APP_NAME = "Maroon 5 Fan Book";
        ...
        private void OnCommandsRequested(SettingsPane sender, SettingsPaneCommandsRequestedEventArgs args)
        {
            ...
            args.Request.ApplicationCommands.Add(new SettingsCommand("Credits", "Credits", (handler) => ShowCreditSettingFlyout()));
        ...
        private void ShowCreditSettingFlyout()
        {
            var flyout = new CreditFlyout();
            flyout.Show();
        }
        #endif
